...
if not LEAGUE_ID:
    raise ValueError("LEAGUE_ID variable missing from config.json")
...
# 2. Query Sleeper's raw master projections matrix for the current week
print("Downloading live player projections stream...")
proj_url = f"https://api.sleeper.app/projections/nfl/{current_year}/{current_week}?season_type=regular&order_by=ppr"
...
for team in matchups:
    ...
    # Store calculation matrix back to dictionary mapping
